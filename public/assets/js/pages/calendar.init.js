!(function (l) {
    ...
    (e.prototype.onDrop = function (e, t) {
        ...
        (e.prototype.onEventClick = function (t, e, n) {
            var a = this,
                o = l("<form></form>");
            o.append("<label>ویرایش نام رویداد</label>"),
                o.append(
                    "<div class='input-group m-b-15'><input class='form-control' type=text value='" +
                        t.title +
                        "' /><span class='input-group-append'><button type='submit' class='btn btn-success btn-md waves-effect waves-light'><i class='fa fa-check'></i> ذخیره</button></span></div>"
                ),
        ...
        (e.prototype.onSelect = function (n, a, e) {
            ...
            i.append("<div class='row'></div>"),
                i
                    .find(".row")
                    .append("<div class='col-md-6'><div class='form-group'><label class='control-label'>نام رویداد</label><input class='form-control' placeholder='نام رویداد' type='text' name='title'/></div></div>")
                ...
                o.$modal.find("form").on("submit", function () {
                    ...
                    return (
                        null !== e && 0 != e.length ? (o.$calendarObj.fullCalendar("renderEvent", { title: e, start: n, end: a, allDay: !1, className: t }, !0), o.$modal.modal("hide")) : alert("You have to give a title to your event"), !1
                    );
                }),
        ...
        (e.prototype.init = function () {
            ...
            var e = new Date(),
                ...
                n = [
                    { title: "خرید", start: new Date(l.now() + 158e6), className: "bg-purple" },
                    { title: "دیدلر با رضا", start: t, end: t, className: "bg-success" },
                    { title: "با جان دیو آشنا شوید", start: new Date(l.now() + 168e6), className: "bg-info" },
                    { title: "خرید یک قالب", start: new Date(l.now() + 338e6), className: "bg-primary" },
                ],
                a = this;
